...
<body style="font-family: myfont" ;>
    ...
    <div class="container p-3 my-3">
              ...
              <form action="InsertBoard.jsp?name=multipart" method ="post" />
                <table class="table table-hover" style="text-align: center;">
                    ...
                    <thead>
                        <tr>
                            <td>
                             <input type="text" placeholder="제목을 입력해주세요." name ="inp_title">
                            </td>
                        </tr>
                    </thead>
                    <tbody>
                        <td>
                            <textarea aria-setsize="2000" placeholder="내용을 작성하세요." name = "inp_contetns"></textarea>
                        </td>
        ...
        <div style="text-align: right;"> <input type="submit" value="완료"></div>
        </form>
    </div>
