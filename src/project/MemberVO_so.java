...
public class MemberVO_so {
	...
	public MemberVO_so(int mem_code, String mem_name, String mem_id, String mem_scr, String mem_pwd, String mem_num,
			int des_code) {
		super();
		this.mem_code = mem_code;
		this.mem_name = mem_name;
	...
	public MemberVO_so(String mem_name, String mem_id, String mem_pwd, String mem_num) {
		super();
		this.mem_name = mem_name;
		this.mem_id = mem_id;
		this.mem_pwd = mem_pwd;
	...
	public MemberVO_so(String mem_id, String mem_pwd) {
		super();
		this.mem_id = mem_id;
		this.mem_pwd = mem_pwd;
	}
